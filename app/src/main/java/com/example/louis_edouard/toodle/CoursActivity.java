...
public class CoursActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor c  = dbHelper.listeCourse();
//        c.moveToFirst();
//        while(!c.isAfterLast()){
//            Log.d("DBH", "id = " + c.getInt(c.getColumnIndex(DBHelper.COURSE_ID)) +
//                    " titre = " + c.getString(c.getColumnIndex(DBHelper.COURSE_SHORTNAME)));
//
//            c.moveToNext();
//        }
...
//            });
            ...
            v.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    dbHelper.deleteCourse(getItemId(p));
                    cursor = dbHelper.listeCourse();
                    changeCursor(cursor);
